...
@dataclass
class DataConfig:
    train_path: str = 'data/Freesound_dataset/freesound_train_curated_manifest_filtered.json'
    val_path: str = 'data/Freesound_dataset/freesound_test_manifest_filtered.json'
    batch_size: int = 32 # reducing from 64 to avoid CUDA out of memory issue 64  # Batch size for training
...
@dataclass
class OptimConfig:
    learning_rate: float = 1.5e-4  # Initial Learning Rate (for a Batch Size of 64, use 1.5e-4)
